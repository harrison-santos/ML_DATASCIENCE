...
#Em previsores.workclass temos agora os valores: 1,2,3...7. Pode acontencer que o algoritmo considere o número 7 mais importante que os outros na hora de gerar o cálcul. Para contornar tal situação podemos aplicar o dummy.
